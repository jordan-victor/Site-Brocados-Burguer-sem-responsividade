...
function mostrarTradicionais(){
    var tradicionais = document.getElementById("tradicionais").style.display = "block"
...
function mostrarArtesanais(){
    var artesanais = document.getElementById("artesanais").style.display = "block"
...
function mostrarDoces(){
    var doces = document.getElementById("doces").style.display = "block"
...
function mostrarCombos(){
    var combos = document.getElementById("combos").style.display = "block"
